//alert("Hello! These are my extra conditionals exercises!") //only works on js file, not for HTML file.
...
function generation (x, y){
    ...
    if (x === -3, y === "f"){ //&& operators work better
        return "You are a great grandmother!";
    }else if (x === -3, y === "m"){
        return "You are a great grandfather!";
    }else{
        return "Sorry, I'll get back to you with that one!"
    }
